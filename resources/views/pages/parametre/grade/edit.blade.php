<x-app-layout>
    ...
    <x-card.card>
        ...
        <form action="{{ route('parametre.grade.update', $grade) }}" method="POST">
            @csrf
            ...
            <div class="px-4 py-2">
                ...
                <label class="block mb-2">
                    ...
                    <input type="text" class="mt-1 block w-full border-gray-300 rounded-md" name="lib_court" value="{{ $grade->lib_court }}">
                </label>

                <label class="block">
                    <span class="text-gray-700">Libelle long</span>
                    <input type="text" class="mt-1 block w-full border-gray-300 rounded-md" name="lib_long" value="{{ $grade->lib_long }}">
                </label>
            </div>
